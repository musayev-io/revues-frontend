        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <!-- <div class="flex-shrink-0">
              <img
                class="h-8 w-8"
                src="/img/logos/workflow-mark-on-brand.svg"
                alt="Revue"
              />
            </div> -->
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline">
                <nuxt-link
                  :to="{ name: 'dashboard' }"
                  class="px-3 py-2 rounded-md text-sm font-medium text-white active:bg-indigo-800 focus:outline-none focus:text-white focus:bg-indigo-600"
                  >Dashboard</nuxt-link
                >
                <nuxt-link
                  :to="{ name: 'brands' }"
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              -->
                <div
                  v-if="this.profileToggledStatus"
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              ...
              <div
                class="mt-1 text-sm font-medium leading-none text-indigo-300"
              >
                tom@example.com
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      profileToggledStatus: false
    }
  },
  methods: {
    profileToggle() {
      this.profileToggledStatus = !this.profileToggledStatus
    }
  }
}
</script>
